...
using Wordly.Core.Models.Messaging;

namespace Wordly.Application.Consumers;
...
public sealed class SampleCommandConsumer : IConsumer<SampleCommand>
{
    ...
    public Task Consume(ConsumeContext<SampleCommand> context)
    {
        ...
        _logger.LogInformation("Command '{Id}' received. Users count: {Count}", context.Message.Id,
            context.Message.UsersCount);
