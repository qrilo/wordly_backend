...
using Wordly.Api.Configuration.Converters;
using Wordly.Api.Configuration.Middleware.Filters;
using Wordly.Api.Configuration.Swagger;
using Wordly.Application;
using Wordly.Application.Validators.Auth;
using Wordly.Core.Options;
using Wordly.DataAccess;

namespace Wordly.Api.Configuration;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.Configure<BlobOptions>(_configuration.GetSection(nameof(BlobOptions)));
